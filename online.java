...
{  
    ...
    {  
        ...
        if(current==8)  
        {  
            l.setText("Que9: Which of these are selection statements in Java?s");  
            jb[0].setText("break");jb[1].setText("continue");jb[2].setText("for()");jb[3].setText("if()");  
        }  
        if(current==9)  
        {  
            l.setText("Que10:  JDK stands for ____.");  
            jb[0].setText("Java deployment kit");jb[1].setText("Java development kit");jb[2].setText("JavaScript deployment kit");  
